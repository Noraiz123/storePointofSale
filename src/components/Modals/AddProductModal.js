  ...
  useEffect(() => {
    if (productData && productData._id) {
      ...
      setProductDetails({
        ...
        name,
        unit,
        category: category?._id ? category._id : null,
        vendor: vendor?._id ? vendor._id : null,
        ...
        <div className='inline-block w-96 my-8 text-left align-middle transition-all transform bg-white shadow-2xl rounded-2xl p-6'>
          ...
          <div className='mt-10 h-70v overflow-y-auto productsAdd'>
            ...
            <div>
              ...
              <div className='flex flex-col my-2'>
                <label className='mb-1 text-gray-500 font-bold'>Unit</label>
                <input
                  className='input-field'
                  type='text'
                  name='unit'
            ...
            <div className='flex flex-col my-2'>
              ...
              <input
                ...
                name='singlePrice'
                type='number'
                value={productDetails.singlePrice}
                onChange={handleAddProduct}
              />
            </div>
            <div className='flex flex-col my-2'>
              <label className='mb-1 text-gray-500 font-bold'>Purchase Price</label>
              <input
                className='input-field'
                name='retailPrice'
                type='number'
            ...
            <div className='flex flex-col my-2'>
              <label className='mb-1 text-gray-500 font-bold'>Quantity in a Bag</label>
              <input
                className='input-field'
                name='bagQuantity'
                type='number'
                value={productDetails.bagQuantity}
                onChange={handleAddProduct}
              />
            </div>
            <div className='flex flex-col my-2'>
